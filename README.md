...
Description
-----------
This module for the Magento online shop software adds the possibility to configure a payment method
...
2. Remove the file app/etc/modules/Vianetz/DefaultPaymentMethod
